...
<TR>
	<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/visit_list.action"
		target=main>－客户拜访列表</A></TD>
			...
			<TR>
				<TD class=menuSmall>
				<A class=style2 href="${pageContext.request.contextPath}/customer_toSelectCustomerPage.action"
					target=main>－ 客户信息查询</A></TD>
			</TR>
			<TR>
				<TD class=menuSmall>
                <A class=style2 href="${pageContext.request.contextPath}/linkMan_toMoreConditionPage.action"
...
<TBODY>
	<TR>
		<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/customer_countBycustSources.action"
			target=main>－客户来源统计</A></TD>
	</TR>
	<TR>
		<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/customer_countBycustLevel.action"
